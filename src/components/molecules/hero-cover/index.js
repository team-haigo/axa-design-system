        ...
        `
          ...
          this.design
                ...
                <div class=m-hero-cover__content>
                    <h5 class=a-typo__category>${
                      this.getAttribute('+category-title') || 'Category title'
                    }</h5>
                    <h2 class=a-typo__page-title>${
                      this.getAttribute('+main-title') || 'Main Title'
                    }</h2>
                    ${
                      content
                    ...
                    ${
                      legalContent
                        ? `<p class="a-typo__legals">${legalContent.innerHTML}</p>`
                        : ''
                    }
